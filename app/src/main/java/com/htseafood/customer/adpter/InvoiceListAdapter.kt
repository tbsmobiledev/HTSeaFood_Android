...
import com.htseafood.customer.activity.InvoiceDetailActivity
import com.htseafood.customer.databinding.ItemInvoiceBinding
...
class InvoiceListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.binding.tvInvoiceNo.text = "Invoice No : #" + invoiceList[position].no
